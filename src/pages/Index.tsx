...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="pt-12 pb-12 sm:pt-40 sm:pb-20 md:pt-48 lg:pt-56 md:pb-32 px-4 sm:px-6">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center space-y-6 sm:space-y-8 animate-fade-in">
            ...
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold leading-tight tracking-tight animate-slide-up animate-delay-100 px-2">
              Transform Data Into
              <span className="block leading-[1.2] text-gradient mt-2">Actionable Insights</span>
            </h1>
